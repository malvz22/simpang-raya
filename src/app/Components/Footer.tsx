  ...
  return (
    <>
      <div className="bg-[#A22020] max-w-full text-white flex flex-col md:flex-row">
        <div className="bg-[#171717] w-full max-w-full md:max-w-[30%] flex flex-col justify-center items-center gap-8">
          <Image
        ...
        <div className="flex flex-col md:flex-row gap-10 p-7">
